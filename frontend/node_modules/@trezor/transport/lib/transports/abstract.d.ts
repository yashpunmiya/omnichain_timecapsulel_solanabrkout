import { Messages, loadDefinitions } from '@trezor/protobuf';
...
declare class TransportEmitter extends TypedEmitter<{
    ...
    [TRANSPORT.ERROR]: typeof ERRORS.HTTP_ERROR | typeof ERRORS.API_DISCONNECTED | typeof ERRORS.WRONG_RESULT_TYPE | typeof ERRORS.UNEXPECTED_ERROR;
}> {
}
...
export declare abstract class AbstractTransport extends TransportEmitter {
    ...
    abstract receive(params: {
        ...
        session: Session;
        protocol?: TransportProtocol;
    } & AbortableParam): AsyncResultWithTypedError<Messages.MessageResponse, ReadWriteError>;
